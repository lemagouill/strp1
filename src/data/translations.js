...
REVIEW IF :risk_score: > 60 
  ...
  en: {
    meta: {
      title: "Corsovault | Global Payment Gateway Consulting & Setup Support",
      description: "Independent consulting and technical integration for international payment gateways (Stripe, PayPal, Adyen). Free audit and global compliance."
    },
    topbar: {
    ...
    hero: {
      ...
      title: "Global Payment Gateway Consulting & Setup Support",
      subtitle: "We help startups and global e-commerce merchants configure, optimize, and secure their international payment gateways (Stripe, PayPal, Adyen, Braintree).",
...
REVIEW IF :risk_score: > 60 
    ...
    audit: {
      ...
      form: {
        ...
        marketsOptions: ["Domestic / France & Francophone", "European Union (Multi-country)", "United Kingdom & United States", "Global International (APAC, LatAm, MENA)"],
...
• **Mesure d'Audience Anonymisée** : Données statistiques globales permettant de mesurer la fréquentation du site sans identification personnelle et sans croisement de données.`
  ...
  en: {
    mentions: {
      title: "Legal Notice & Company Disclosures",
      subtitle: "Published in accordance with European e-commerce transparency directives and corporate disclosure laws.",
      sections: [
        {
          heading: "1. Corporate Entity & Site Publisher",
          content: `The website corsovault.com is operated by **Corsovault Advisory SAS**, a simplified joint-stock company with a share capital of €25,000.00, registered with the Paris Trade and Companies Register under number **921 843 710**.
...
• **Director of Publication**: Alexandre Corsovault, President
• **Telephone**: +33 1 89 71 42 30
• **Official Email**: contact@corsovault.com`
        },
        {
          heading: "2. Cloud Hosting Provider",
          content: `The site is hosted on enterprise redundant infrastructure by:
• **Provider**: Vercel Inc. / Amazon Web Services EMEA SARL
• **Address**: 38 Avenue John F. Kennedy, L-1855 Luxembourg / 440 N Barranca Ave #4133 Covina, CA 91723, USA
• **Website**: https://vercel.com / https://aws.amazon.com`
        },
        {
          heading: "3. Business Scope & Non-Affiliation Disclaimer",
          content: `Corsovault Advisory SAS provides professional software engineering, systems architecture, and strategic advisory services specializing in global payment gateway integrations.
          
**IMPORTANT NON-AFFILIATION NOTICE**: Corsovault Advisory SAS is an independent advisory firm and is not a bank, credit institution, or licensed money services business. Corsovault does not hold, transmit, or custody customer funds at any stage.
          
All third-party trademarks cited (including Stripe®, PayPal®, Braintree®, Adyen®, Apple Pay®, Google Pay®, Klarna®, iDEAL®) remain the exclusive property of their respective trademark holders. Mention of these names is purely descriptive of technical compatibility and does not imply any partnership, official sponsorship, or endorsement.`
        },
        {
          heading: "4. Intellectual Property",
          content: `All original content, technical documentation, design elements, and interactive tools on this website are the proprietary property of Corsovault Advisory SAS. Unauthorized reproduction, scraping, or distribution is prohibited.`
        }
      ]
    },
    privacy: {
      title: "Privacy Policy & GDPR Compliance Statement",
      subtitle: "Last updated: February 1, 2026. Fully compliant with GDPR (EU 2016/679) and international privacy frameworks.",
      sections: [
        {
          heading: "1. Data Controller",
          content: `The Data Controller responsible for processing personal data on this website is:
**Corsovault Advisory SAS**, 38 Rue de la Boétie, 75008 Paris, France.
Data Protection Officer (DPO): dpo@corsovault.com.`
        },
        {
          heading: "2. Personal Data Collected & Purposes",
          content: `We collect and process only the minimal business data required for:
1. **Free Audit & Contact Inquiries**: Name, professional email, phone number, company name, monthly processing volume, and payment tech stack. *(Legal basis: Performance of pre-contractual measures upon user request - Art. 6.1.b GDPR)*.
2. **Consulting Engagements**: Business contact information and technical integration parameters. *(Legal basis: Contract execution)*.
3. **Anonymized Technical Metrics**: Non-tracking web analytics to preserve system performance and security.`
        },
        {
          heading: "3. Strict Zero Cardholder Data Handling",
          content: `Corsovault Advisory SAS NEVER collects, stores, or processes complete customer primary account numbers (PAN), expiration dates, or security codes (CVC/CVV). All audits and configurations strictly focus on API logic interacting with PCI-DSS Level 1 certified processors.`
        },
        {
          heading: "4. Data Retention Periods",
          content: `• **Prospective Inquiry Data**: Retained for a maximum of 3 years following the latest business interaction.
• **Client Records**: Retained for the active duration of the contract, then archived for statutory commercial (5 years) and accounting (10 years) obligations.`
        },
        {
          heading: "5. Your Privacy Rights",
          content: `Under applicable law, you have the right to access, rectify, port, or erase your personal data, as well as the right to restrict or object to processing. To exercise these rights, contact our Data Protection Officer at **dpo@corsovault.com**.`
        }
      ]
    },
    terms: {
      title: "Terms of Service & Consulting Agreement",
      subtitle: "Governing professional advisory and integration services provided by Corsovault Advisory SAS.",
      sections: [
        {
          heading: "Article 1 - Purpose & Scope",
          content: `These Terms of Service define the terms and conditions under which Corsovault Advisory SAS ('Provider') renders technical consulting, architecture audits, and payment gateway integration support to business clients ('Client').`
        },
        {
          heading: "Article 2 - Proposals, Orders & Deliverables",
          content: `Each engagement is defined by a proposal or work order detailing scope, deliverables, and estimated timelines. Orders become binding upon signature and receipt of the designated deposit payment.`
        },
        {
          heading: "Article 3 - Client Responsibilities & Security",
          content: `The Client agrees to grant restricted, role-based developer access (with zero payout or banking transfer permissions) necessary to execute the technical tasks. The Client remains solely responsible for its own regulatory compliance and relationship with merchant processors.`
        },
        {
          heading: "Article 4 - Payment & Terms",
        ...
        {
          heading: "Article 6 - Applicable Law & Jurisdiction",
    ...
    refund: {
      ...
      subtitle: "Standard commercial policies for advisory and integration engagements.",
      sections: [
        {
          heading: "1. B2B Advisory Services",
        ...
        {
          heading: "2. Cancellation Prior to Commencement",
        ...
        {
          heading: "3. Post-Delivery Support & Guarantee",
          content: `Sprint Setup and Growth Optimization packages include 14 to 30 days of post-launch engineering support to ensure all integrated endpoints and workflows operate according to documented specifications.`
        }
      ]
    },
    cookies: {
      ...
      sections: [
        ...
        },
        {
          ...
          content: `• **Essential Cookies**: Strictly necessary for page routing, language selection (FR/EN), and consent state.
